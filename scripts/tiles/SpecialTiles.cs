	...
	public void EntityHit(Entity entity, KinematicCollision2D collision)
	{
		...
		foreach (var tile in tiles)
		{
			switch (tile)
			{
				...
				case 2:
					{
						entity.Gravity = entity.DefGravity * 2;
						entity.GravityReset = 0.1f;
						if (entity.MaxJumpTime == entity.DefMaxJumpTime) entity.MaxJumpTime = entity.DefMaxJumpTime / 2;
						if (entity.StartJump == entity.DefStartJump) entity.StartJump = entity.DefStartJump * 2 / 3;
						if (entity.EndJump == entity.DefEndJump) entity.EndJump = entity.DefEndJump * 2 / 3;
						entity.JumpReset = 0.1f;
						break;
					}
			}
